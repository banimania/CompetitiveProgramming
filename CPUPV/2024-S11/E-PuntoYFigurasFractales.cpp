...
ll vecesCirc(long r, long double x, long double y, long double ox, long double oy) {
  ll veces = sqrt(pow(x - ox, 2) + pow(y - oy, 2)) <= r;

  if (r <= 1) return veces;

  if ((y - oy > x - ox) && (y - oy > ox - x)) veces += vecesCirc(r / 2, x, y, ox, oy + r);
  else if ((y - oy < x - ox) && (y - oy > ox - x)) veces += vecesCirc(r / 2, x, y, ox + r, oy);
  else if ((y - oy < x - ox) && (y - oy < ox - x)) veces += vecesCirc(r / 2, x, y, ox, oy - r);
  else veces += vecesCirc(r / 2, x, y, ox - r, oy);
