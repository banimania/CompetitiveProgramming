...
void solve() {
  ...
  if (clima == "Soleado" && t >= 20) vienen.push_back("Adrian");
  if (clima == "Soleado" || t > 15) vienen.push_back("Barbara");
  if (clima == "Soleado" || clima == "Nublado") vienen.push_back("Carmen");
  if (clima != "Tormenta") vienen.push_back("Dario");
