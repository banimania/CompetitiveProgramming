...
void solve() {
  ...
  cout << ans << endl;
  // int current = 0;
  // int maxCiclo = INT_MIN, minCiclo = INT_MAX;
  // for (int i = 0; i < moves.size(); i++) {
  //   current += (moves[i] == 'R' ? 1 : -1);
  //   maxCiclo = max(maxCiclo, current);
  //   minCiclo = min(minCiclo, current);
  // }
  // 
  // if ()

  // cout << minCiclo << " " << maxCiclo << " current = " << current << endl;
}
