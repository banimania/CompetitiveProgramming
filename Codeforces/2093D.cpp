...
void ansQueryXY(ll base, ll x, ll y, ll side) {
  // cout << "ansQueryXY(" << base << ", " << x << ", " << y << ", " << side << ")" << endl;
  if (side == 2) {
    if (x == 1 && y == 1) {
      cout << base + 1 << endl;
    } else if (x == 2 && y == 2) {
  ...
  if (x <= side / 2 && y <= side / 2) { // q1
    ansQueryXY(base, x, y, side / 2);
  } else if (x > side / 2 && y > side / 2) { // q2
    ansQueryXY(base + add, x - side / 2, y - side / 2, side / 2);
  } else if (x <= side / 2 && y > side / 2) { // q3
    ansQueryXY(base + 2 * add, x, y - side / 2, side / 2);
  } else { // q4
    ansQueryXY(base + 3 * add, x - side / 2, y, side / 2);
  }
}

void ansQueryD(ll d, ll x, ll y, ll side) {
  if (side == 2) {
    if (d == 1) {
      // cout << x << " " << y << endl;
      cout << y << " " << x << endl;
  ...
  ll quarter = (side * side) / 4;

  if (d <= quarter) {
    ansQueryD(d, x, y, side / 2);
  } else if (d <= 2 * quarter) {
    ansQueryD(d - quarter, x + side / 2, y + side / 2, side / 2);
  } else if (d <= 3 * quarter) {
    ansQueryD(d - 2 * quarter, x, y + side / 2, side / 2);
  } else {
    ansQueryD(d - 3 * quarter, x + side / 2, y, side / 2);
  }
}
...
void solve() {
  ...
  for (int i = 0; i < q; i++) {
    ...
    if (s == "->") {
      ...
      ansQueryXY(0, y, x, side);
    } else {
      ll d;
      cin >> d;

      ansQueryD(d, 1, 1, side);
    }
  }
}
