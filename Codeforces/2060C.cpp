...
void solve() {
  ...
  //       if (safe) break;
  //     }
  //     aliceNum = a[currentNum];
  //     // cout << "ALICE SELECTED " << a[currentNum] << endl;
  //   } else {
  //     REP (i, 0, a.size()) {
  //       currentNum = i;
  //       if (a[currentNum] + aliceNum == k) {
  //         score++;
  //         break;
  //       }
  //     }
  //     // cout << "BOB SELECTED " << a[currentNum] << endl;
  //   }

  //   a.erase(a.begin() + currentNum);
  //   // PRINT(a);
  //   alice = !alice;
  // }
